...
import numpy as np
import pickle
from sgpp_simStorage import calculate_missing_values
...
if __name__ == "__main__":
    ...
    for i, test_strategy in enumerate(test_strategies):
        ...
        print(
            f'precalculated {test_strategy} response surface with {precalculatedReSurf.getSize()} points  has been loaded')
