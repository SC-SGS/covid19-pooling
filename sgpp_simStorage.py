...
def generateKey(prob_sick, success_rate_test, false_positive_rate, group_size,
    ...
    # else:
    return tuple([prob_sick, success_rate_test, false_positive_rate, group_size,
                  test_strategy, num_simultaneous_tests, test_duration, number_of_instances,
                  sample_size])
...
class sgpp_simStorage():
    ...
    def eval(self, x, qoi, recalculate=False):
        ...
        key = generateKey(prob_sick, success_rate_test, false_positive_rate, group_size,
                          self.test_strategy, self.reference_num_simultaneous_tests, self.reference_test_duration,
                          self.number_of_instances, self.reference_sample_size)
